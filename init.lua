...
require('lazy').setup({
  ...
  },
  {
    ...
    --   'BufReadPre /mnt/c/Users/Dino/Documents/Obsidian/Personal/*.md',
    --   'BufNewFile /mnt/c/Users/Dino/Documents/Obsidian/Personal/*.md',
    -- },
    dependencies = {
      -- Required.
    ...
    opts = {
      workspaces = {
        {
          name = 'personal',
          path = '/mnt/c/Users/Dino/Documents/Obsidian/Personal/',
        },
      },
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      end, { desc = 'Search with Hidden Files' })
